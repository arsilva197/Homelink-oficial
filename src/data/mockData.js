...
// Extracted from prototype v2 — replace with real API calls
...
export const INTERESTS = [
  {id:'INT-001',owner:'usuario',title:'Casa em Vila Mariana',en:'House in Vila Mariana',type:'Casa',city:'São Paulo',hood:'Vila Mariana',min_p:800000,max_p:1300000,min_size:120,min_beds:3,notes:'Prefiro condomínio fechado, área de lazer.',status:'ATIVO'},
  {id:'INT-002',owner:'usuario',title:'Terreno Comercial Paulista',en:'Commercial Land',type:'Comercial',city:'São Paulo',hood:'Paulista',min_p:400000,max_p:700000,min_size:60,min_beds:0,notes:'Para montar escritório.',status:'MATCH'},
  {id:'INT-003',owner:'usuario',title:'Apartamento em Savassi',en:'Apt in Savassi',type:'Apartamento',city:'Belo Horizonte',hood:'Savassi',min_p:450000,max_p:650000,min_size:55,min_beds:2,notes:'Andar alto, vaga de garagem.',status:'MATCH'},
  {id:'INT-004',owner:'usuario',title:'Casa com Quintal em BH',en:'House with Garden',type:'Casa',city:'Belo Horizonte',hood:'Lourdes',min_p:700000,max_p:1000000,min_size:140,min_beds:3,notes:'Para família. Quintal obrigatório.',status:'ATIVO'},
  {id:'INT-005',owner:'usuario',title:'Studio no Centro SP',en:'Studio Downtown SP',type:'Apartamento',city:'São Paulo',hood:'Centro',min_p:300000,max_p:500000,min_size:35,min_beds:1,notes:'Investimento para aluguel.',status:'ATIVO'},
  {id:'INT-006',owner:'broker',title:'Cobertura no Leblon',en:'Penthouse in Leblon',type:'Apartamento',city:'Rio de Janeiro',hood:'Leblon',min_p:3000000,max_p:6000000,min_size:200,min_beds:4,notes:'Para cliente VIP — piscina e terraço obrigatórios.',status:'ATIVO'},
  {id:'INT-007',owner:'broker',title:'Casa de Alto Padrão em Higienópolis',en:'Luxury House Higienópolis',type:'Casa',city:'São Paulo',hood:'Higienópolis',min_p:2500000,max_p:4500000,min_size:300,min_beds:4,notes:'Garagem para 4 carros, área gourmet.',status:'ATIVO'},
  {id:'INT-008',owner:'broker',title:'Flat para Investimento',en:'Investment Flat',type:'Apartamento',city:'São Paulo',hood:'Consolação',min_p:400000,max_p:700000,min_size:40,min_beds:1,notes:'Portfólio de investimentos — renda passiva.',status:'MATCH'},
  {id:'INT-009',owner:'agency',title:'Galpão Industrial na Grande SP',en:'Industrial Warehouse Greater SP',type:'Comercial',city:'São Paulo',hood:'Santo André',min_p:2000000,max_p:5000000,min_size:800,min_beds:0,notes:'Para cliente logística. Pé-direito alto.',status:'ATIVO'},
  {id:'INT-010',owner:'agency',title:'Conjunto Comercial na Faria Lima',en:'Office Suite Faria Lima',type:'Comercial',city:'São Paulo',hood:'Itaim Bibi',min_p:1500000,max_p:3000000,min_size:150,min_beds:0,notes:'Escritório corporativo.',status:'ATIVO'},
  {id:'INT-011',owner:'agency',title:'Apartamento 3 quartos na Barra',en:'3-bed Apt Barra da Tijuca',type:'Apartamento',city:'Rio de Janeiro',hood:'Barra da Tijuca',min_p:900000,max_p:1600000,min_size:110,min_beds:3,notes:'Lazer completo, vaga dupla.',status:'MATCH'},
];
...
export const BROKERS_DATA = [
  {id:'BRK-01',name:'João Corretor',creci:'12345',agency:'Imobiliária Paulista',agency_id:'AGN-01',status:'active',opps:2,commission:96000},
  {id:'BRK-02',name:'Maria Corretora',creci:'67890',agency:'RJ Imóveis',agency_id:'AGN-02',status:'active',opps:1,commission:0},
  {id:'BRK-03',name:'Paulo Agente',creci:'54321',agency:'BH Prime',agency_id:'AGN-03',status:'active',opps:0,commission:0},
  {id:'BRK-04',name:'Lucas Autônomo',creci:'11111',agency:null,agency_id:null,status:'active',opps:0,commission:0},
  {id:'BRK-05',name:'Ana Independente',creci:'22222',agency:null,agency_id:null,status:'pending',opps:0,commission:0},
];
